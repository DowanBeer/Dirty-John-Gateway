...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "djgateway@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "djgateway API";

        private String description = "djgateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "djgateway";
