...
import beer.dowan.dj.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("beer.dowan.dj.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("beer.dowan.dj.repository.search")
